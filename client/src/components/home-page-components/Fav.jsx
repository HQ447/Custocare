...
function Fav() {
      ...
      <div className="pt-20 min-h-screen bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="text-center py-16">
            <ShoppingBag className="mx-auto md:h-24 md-20 w-20 md:w-24 text-gray-300 mb-4" />
            <h2 className="md:text-2xl text-xl font-semibold text-gray-600 mb-2">
              Your cart is empty
            </h2>
  ...
  return (
    <div className="pt-14 md:pt-20 min-h-screen bg-gray-50">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-shrink-0">
                      <img
                        src={item.img}
                        alt={item.foodName}
                        className="md:w-20 w-15 h-15 md:h-20 object-cover rounded-xl shadow-sm"
                      />
                    </div>
                        ...
                        <div className="flex items-center space-x-3">
                          <div className="flex items-center border border-gray-200 rounded-lg">
                            <button
                              ...
                              className="p-1 md:p-2 hover:bg-gray-50 transition-colors"
                            >
                              <Minus className="h-4 w-4 text-gray-600" />
                            </button>
                            <span className="md:px-4 px-2 py-1 md:py-2 font-medium text-gray-900">
                              {item.qty}
                            </span>
                            <button
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
              ...
              <button
                ...
                className="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold md:py-4 py-2 md:px-6 rounded-xl transition-colors flex items-center justify-center space-x-2 group"
              >
